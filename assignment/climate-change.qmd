...
**Answer 1:**
CO2 concentration has exponentially increased, from 1958 to current day concentrations has increased annually.
**Question 2:**
...
**Answer 4:**
```{r}
data <- read.delim('nasadata.txt')

df <- read.table('nasadata.txt',  
                  header = TRUE,    
                  fill = TRUE)  
```
